...
//		if (currentUser != null && currentUser.getIsAdmin() == Boolean.TRUE) { bo di de khoi dang nhap
...
//		}
	...
	private void doGetOverView(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher requesDispatcher = req.getRequestDispatcher("/view/admin/video-overview.jsp");
	...
	private void doGetAdd(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher requesDispatcher = req.getRequestDispatcher("/view/admin/video-edit.jsp");
		requesDispatcher.forward(req, resp);
	}
