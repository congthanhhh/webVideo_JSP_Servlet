...
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = NamedStored.FIND_USERS_LIKE_VIDEO_BY_VIDEO_HREF,
			procedureName = "sp_selectUsersLikedVideoByVideoHref",
			resultClasses = {User.class},
			parameters = @StoredProcedureParameter(name = NamedStored.PARAM_VIDEO_HREF, type = String.class))
})
@Entity
@Table(name = "`user`")
public class User {
