        	...
        	<c:forEach items="${videos}" var="video">
        		...
        		<h5 class="tm-text-secondary" style="white-space: nowrap; overflow: hidden;">
	                ...
	                <figure class="effect-ming tm-video-item">
	                    <img src="${video.poster}" alt="Image" class="img-fluid"> <!-- xem video https://www.youtube.com/watch?v=Rc1mco2fLxI&list=PLq_qdoIvaWNDeMllH8ZWhwyCSNeknJXiB&index=7 -->
