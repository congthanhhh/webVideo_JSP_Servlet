      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="'<c:url value ='/template/admin/dist/img/user1-128x128.jpg" alt="User Avatar'/>" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<c:url value ='/template/admin/dist/img/user8-128x128.jpg" alt="User Avatar'/>" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<c:url value ='/template/admin/dist/img/user3-128x128.jpg" alt="User Avatar'/>" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
               ...
               <table id="example1" class="table table-bordered table-striped">
                 ...
                 <c:forEach items="${videos}" var="item">
	                 <tr>
	                   ...
	                   <td><a href="<c:url value='/video?action=watch&id=${item.href}' />"></a> ${item.href}</td>
	                   <td><img src="${item.poster }" height="150px"/></td>
	                   <td>
	                   		<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>" class="btn btn-success">Edit</a>
	                   		<button onclick="deleteVideo('${item.href}')" class="btn btn-danger">Delete</button>
	                   </td>
	                 </tr>
                 </c:forEach>
                 </tbody>
...
<script>
  ...
  function deleteVideo(href) {
	  $.ajax({
		  url:'/webVideoJ4/admin/video?action=delete&href='+href
	  }).then(function(data){
		  window.location.href = 'http://localhost:8080/webVideoJ4/admin/video?action=view'
	  }).fail(function(error){
		  aleart("Delete failed!");
	  })
  }
