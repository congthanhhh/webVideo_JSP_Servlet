<%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        <div class="container-fluid">
            ...
            <c:choose>
            	<c:when test = "${not empty sessionScope.currentUser}">
	                <li class="nav-item">
	                    <a class="nav-link nav-link-1 active" aria-current="page" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Well come ${sessionScope.currentUser.username}</a>
	                </li>
	                <li class="nav-item">
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="<c:url value ='/template/user/img/header_image.jpg'/>">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="changePassBtn" class="btn btn-success">Save</button>
